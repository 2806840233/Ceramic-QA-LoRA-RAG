...
# 1. 配置
# ======================================================
PRED_FILE = r"CompareWithOtherModel\GLM-4-9B-Chat\CeramicQA_val_pred_glm.jsonl"
OUT_CSV = r"CompareWithOtherModel\GLM-4-9B-Chat\CeramicQA_val_metrics_glm.csv"
